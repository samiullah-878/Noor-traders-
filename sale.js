// sale.js — Nayi Sale (Counter / Wholesale) — v1.78.0
...
import { saleStock, setSaleScanHook, setSaleQtyHook, setSaleFindHook, setSaleCartHook, setSaleDelHook, openSaleCamera } from './pos-stock.js?v=1.78.0';
import { smartSearch, topItems, noteHit, voiceSearch } from './smart-search.js?v=1.78.0';
