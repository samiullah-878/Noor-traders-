...
import {posSetup,renderPOS,posBack,posStop} from './pos-ledger.js?v=2.13.1';
import {stockSetup,renderStock,stockStop,stockReport,billRates,saleStock,inReport,setInPdf,setTolai,gintiReport,setGintiPdf} from './pos-stock.js?v=2.13.1';
import {saleSetup,renderSale} from './sale.js?v=2.13.1';
import {ppSetup,renderPP,ppLoadBill} from './purchase.js?v=2.13.1';
import {geoSetup,geoWatch,geoStop,geoEnsure,geoOwnerForm} from './geo-guard.js?v=2.13.1';
import {TYPES,money,cents,norm,balance as rawBalance,daily,yesterday,inDaily} from './model.js';
import {shrinkForAI,readPages,pickModel,pickProModel,matchTally,readPurchaseBill,readLabel} from './ai-tally.js?v=2.13.1';
import {tolaiSetup,openTolai,tolaiClick,tolaiReport,setTolaiPdf} from './tolai.js?v=2.13.1';
import {smartSearch,partyScore,notePartyPick,partyPicks,aliasOf} from './smart-search.js?v=2.13.1';
...
${owner()?setGrp('🔗 Update',setRow('updLinks','🔗','Update ke links','GitHub · Firebase · rules · version check')+setRow('dataSizeBtn','📊','Data ka size','Kitni entries · tasveerein · kitne MB — app dheemi kyun')):''}
