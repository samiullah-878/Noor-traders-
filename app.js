...
import {posSetup,renderPOS,posBack,posStop} from './pos-ledger.js?v=2.4.1';
import {stockSetup,renderStock,stockStop,stockReport,billRates,saleStock} from './pos-stock.js?v=2.4.1';
import {saleSetup,renderSale} from './sale.js?v=2.4.1';
import {ppSetup,renderPP,ppLoadBill} from './purchase.js?v=2.4.1';
import {geoSetup,geoWatch,geoStop,geoEnsure,geoOwnerForm} from './geo-guard.js?v=2.4.1';
import {TYPES,money,cents,norm,balance as rawBalance,daily,yesterday,inDaily} from './model.js';
import {shrinkForAI,readPages,pickModel,pickProModel,matchTally,readPurchaseBill} from './ai-tally.js?v=2.4.1';
import {smartSearch,partyScore,notePartyPick,partyPicks,aliasOf} from './smart-search.js?v=2.4.1';
